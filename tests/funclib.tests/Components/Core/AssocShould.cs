...
namespace funclib.Tests.Components.Core
{
    public class AssocShould
    {
        ...
        public void Assoc_should_add_item_params_to_an_empty_map()
        {
            ...
            var actual = assoc(new HashMap().Invoke(), ":key1", "value", ":key2", "another value", ":key3", "value3");
        ...
        public void Assoc_should_add_items_params_to_a_map()
        {
            ...
            var actual = assoc(new HashMap().Invoke(":key1", "old value1", ":key2", "value2"), ":key1", "value1", ":key3", "value3");
        ...
        {
            Assert.Throws<ArgumentException>(() => assoc(new HashMap().Invoke(), ":key1", "value1", ":key3"));
        }

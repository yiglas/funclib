...
namespace funclib.Tests.Components.Core
{
    public class ApplyShould
    {
        ...
        public void Apply_should_apply_each_item_in_array_to_the_function()
        {
            ...
            var actual = apply(new Str(), new Vector().Invoke("str1", "str2", "str3"));
        ...
        {
            var expected = "str1str2str3";
            var actual = apply(new Str(), "str1", new Vector().Invoke("str2", "str3"));
        ...
        {
            var expected = 3;
            var actual = apply(new Max(), 1, 2, new Vector().Invoke(3));

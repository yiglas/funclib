...
namespace funclib.Tests.Components.Core
{
    public class SelectKeysShould
    {
        ...
        public void SelectKeys_should_pull_keys_that_exists_from_a_map()
        {
            ...
            var actual = selectKeys(arrayMap(":a", 1, ":b", 2), new Vector().Invoke(":a"));
        ...
        {
            var expected = arrayMap(":a", 1);
            var actual = selectKeys(arrayMap(":a", 1, ":b", 2), new Vector().Invoke(":a", ":c"));
        ...
        public void SelectedKeys_should_work_with_passing_vectors_as_well()
        {
            ...
            var actual = selectKeys(new Vector().Invoke(1, 2, 3), new Vector().Invoke(0, 0, 2));

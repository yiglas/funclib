...
namespace funclib.Components.Core.Generic
{
    ...
    /// <typeparam name="T7">Generic type of the seventh input object.</typeparam>
    ...
    {
        readonly Func<T1, T2, T3, T4, T5, T6, T7, TResult> _func;

        /// <summary>
        /// Creates a <see cref="Function{T1, T2, T3, T4, T5, T6, T7, TResult}"/> from a <see cref="Func{T1, T2, T3, T4, T5, T6, T7, TResult}"/>.
        /// </summary>
        /// <param name="x">A <see cref="Func{T1, T2, T3, T4, T5, T6, TResult}"/> to execute.</param>
        public Function(Func<T1, T2, T3, T4, T5, T6, T7, TResult> x)
        {
            this._func = x;
        }

        /// <summary>
        /// Invokes the <see cref="Func{T1, T2, T3, T4, T6, T7, TResult}"/>.
        /// </summary>
        ...
        /// <param name="g">Seventh parameter of the function.</param>
        /// <returns>
        /// Returns the results of the <see cref="Func{T1, T2, T3, T4, T5, T6, T7, TResult}"/> function.
        /// </returns>
        public TResult Invoke(T1 a, T2 b, T3 c, T4 d, T5 e, T6 f, T7 g) => this._func(a, b, c, d, e, f, g);
    }
}

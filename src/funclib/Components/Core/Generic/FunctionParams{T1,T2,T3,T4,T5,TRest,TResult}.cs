...
namespace funclib.Components.Core.Generic
{
    ...
    public class FunctionParams<T1, T2, T3, T4, T5, TRest, TResult> :
        IFunctionParams<T1, T2, T3, T4, T5, TRest, TResult>
    {
        readonly Func<T1, T2, T3, T4, T5, TRest[], TResult> _func;

        /// <summary>
        /// Creates a <see cref="FunctionParams{T1, T2, T3, T4, T5, TRest, TResult}"/> from a <see cref="Func{T1, T2, T3, T4, T5, TRest, TResult}"/>.
        /// </summary>
        /// <param name="x">A <see cref="Func{T1, T2, T3, T4, T5, TRest, TResult}"/> to execute.</param>
        public FunctionParams(Func<T1, T2, T3, T4, T5, TRest[], TResult> x)
        {
            this._func = x;
        }

        /// <summary>
        /// Invokes the <see cref="Func{T1, T2, T3, T4, T5, TRest, TResult}"/>.
        /// </summary>
        ...
        /// <returns>
        /// Returns the results of the <see cref="Func{T1, T2, T3, T4, T5, TRest, TResult}"/> function.
        /// </returns>
        public TResult Invoke(T1 a, T2 b, T3 c, T4 d, T5 e, params TRest[] args) => this._func(a, b, c, d, e, args);
    }
}

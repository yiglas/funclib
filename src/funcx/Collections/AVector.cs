        ...
        IFunction<object, object>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is IVector v)
            {
                ...
                {
                    if (!new Core.Equals().Invoke(this[i], v[i]))
                        return false;
                }
            ...
            if (obj is IList l)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    if (!new Core.Equals().Invoke(this[i], l[i]))
                        return false;
                }
            ...
            if (obj is ISeq e)
            {
                ...
                {
                    if (e == null || !new Core.Equals().Invoke(this[i], e.First()))
                        return false;
                }
        ...
        {
            for (int i = 0; i < Count; i++)
                if (new Core.Equals().Invoke(this[i], value))
                    return i;
